    ...
    return (
        <ImageBackground source={bg} style={styles.container}>
            ...
            <ScrollView contentContainerStyle={{ alignItems: "center" }} style={styles.bottomcontainer}>
                ...
                <TextInput placeholder="Email Address" placeholderTextColor="#aaa" style={styles.inputsimple} />
                ...
                <View style={styles.passwordContainer}>
                    ...
                    <TouchableOpacity onPress={() => setPasswordVisible(!passwordVisible)} style={styles.eyeButton}>
                        <Image source={passwordVisible ? eyeClose : eyeClose} style={styles.eyeIcon} />
                    </TouchableOpacity>
                </View>
...
const styles = StyleSheet.create({
    ...
    subtitle: { color: '#FFFFFF', fontSize: 14, marginBottom: 20, fontFamily: "Inter-Medium", width: "50%", textAlign: 'center', marginBottom: 8 },
    passwordContainer: {
        width: '100%',
        flexDirection: 'row',
        alignItems: 'center',
    ...
    forgot: { alignSelf: 'flex-end', marginTop: 15, marginBottom: 20 },
