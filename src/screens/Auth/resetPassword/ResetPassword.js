...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 28, color: '#EFEFEF', fontFamily: "Outfit-SemiBold", marginTop: 25, marginBottom: 8, },
    subtitle: { color: '#FFFFFF', fontSize: 14, marginBottom: 25, fontFamily: "Outfit-Medium", textAlign: 'center', marginBottom: 25 },
    passwordContainer: {
        width: '100%',
        flexDirection: 'row',
        alignItems: 'center',
    ...
    inputsimple: { width: '100%', backgroundColor: "#0d151e", color: '#fff', fontFamily: "Outfit-Regular", borderRadius: 8, padding: 15, marginTop: 10, borderWidth: 0.8, borderColor: theme.borderColor, justifyContent: "space-between", flexDirection: "row", height: 50, },
    eyeButton: {
        position: "absolute",
    ...
    forgotText: { color: '#FFFFFF', fontSize: 11, fontFamily: "Outfit-Medium", },
    label: { fontFamily: "Outfit-Medium", width: "100%", textAlign: "left", color: '#FFFFFF', fontSize: 13, marginTop: 17, marginBottom: 5 },
    button: {
        backgroundColor: theme.primaryColor, width: '100%',
        padding: 15, borderRadius: 14, marginTop: 20, alignItems: 'center'
    },
    buttonText: { color: '#fff', fontSize: 17, fontWeight: '600', fontFamily: "Outfit-SemiBold", },
    orContainer: {
        marginVertical: 28,
        flexDirection: "row",
        alignItems: "center",
    ...
    googleText: { color: '#fff', marginLeft: 10, fontFamily: "Outfit-Medium", },
    footer: { color: '#ccc', marginTop: 33, marginBottom: 40, fontFamily: "Outfit-Regular", fontSize: 12, },
